        ...
        <div className="mt-10 flex justify-center ">
          <Card className="w-96">
            ...
            <CardFooter className="pt-0">
              <Button className="bg-[#29276B]" onClick={handleClick} fullWidth>
                Login
              </Button>
              <Typography variant="small" className="mt-6 flex justify-center">
                Don&apos;t have an account?
                <Link className="ml-1 font-bold text-[#F04923] " to="/register">
                  {" "}
                  Register
                </Link>
              </Typography>
              <div className="mt-6 ">
                <Button
                  ...
                  size="md"
                  variant="outlined"
                  className="flex text-[#29276B] font-extrabold items-center justify-center gap-3 w-11/12 mx-auto"
                >
